...
const GP_SEED_PRODUCTS = [
  { id: 1, name: "밀양 스마트팜 딸기 1kg", emoji: "🍓", farm: "밀양 A농원", region: "경상남도 밀양시", category: "과일", price: 22000, measured: true, water: 80, soil: 1.0, carbon: 110, badge: { text: "인기", type: "hot" }, stock: 20,
    ...
    gallery: [
      { url: gpPx(1998893), caption: "대표 이미지", isSample: true },
      { url: gpPx(1350964), caption: "신선 과육 클로즈업", isSample: true },
      { url: gpPx(30517931), caption: "패키지 구성", isSample: true },
      { url: gpPx(4038801), caption: "당도 확인", isSample: true },
      { url: gpPx(4984391), caption: "수확 현장", isSample: true },
      { url: gpPx(36853097), caption: "밀양 A농원 스마트팜 전경", isSample: true },
      { url: gpPx(16905006), caption: "환경 모니터링 센서", isSample: true },
    ],
  ...
  { id: 2, name: "밀양 대추방울토마토 1kg", emoji: "🍅", farm: "밀양 B농원", region: "경상남도 밀양시", category: "채소", price: 13000, measured: true, water: 70, soil: 0.9, carbon: 100, badge: { text: "마감임박", type: "urgent" }, stock: 6,
    ...
    gallery: [
      { url: gpPx(33499935), caption: "대표 이미지", isSample: true },
      { url: gpPx(16038526), caption: "신선 과육 클로즈업", isSample: true },
      { url: gpPx(18076426), caption: "패키지 구성", isSample: true },
      { url: gpPx(7522774), caption: "수확 직후", isSample: true },
      { url: gpPx(2894282), caption: "수확 현장", isSample: true },
      { url: gpPx(14938733), caption: "밀양 B농원 스마트팜 전경", isSample: true },
      { url: gpPx(6792187), caption: "환경 모니터링 장비", isSample: true },
    ],
  ...
  { id: 3, name: "밀양 컬러 파프리카 3입", emoji: "🫑", farm: "밀양 B농원", region: "경상남도 밀양시", category: "채소", price: 9000, measured: true, water: 55, soil: 0.7, carbon: 85, badge: { text: "신상품", type: "new" }, stock: 25,
    ...
    gallery: [
      { url: gpPx(18640811), caption: "대표 이미지", isSample: true },
      { url: gpPx(35525568), caption: "컬러 구성", isSample: true },
      { url: gpPx(7657012), caption: "패키지 구성", isSample: true },
      { url: gpPx(1843385), caption: "수확 직후", isSample: true },
      { url: gpPx(27542123), caption: "수확 현장", isSample: true },
      { url: gpPx(14938733), caption: "밀양 B농원 스마트팜 전경", isSample: true },
      { url: gpPx(6792187), caption: "환경 모니터링 장비", isSample: true },
    ],
  ...
  { id: 4, name: "시금치 1kg", emoji: "🥬", farm: "청정 D농원", region: "충청남도 논산시", category: "채소", price: 9000, measured: false, water: 40, soil: 0.5, carbon: 60, stock: 30,
    ...
    gallery: [
      { url: gpPx(38571502), caption: "대표 이미지", isSample: true },
      { url: gpPx(19957370), caption: "패키지 구성", isSample: true },
      { url: gpPx(7511845), caption: "신선 잎 클로즈업", isSample: true },
      { url: gpPx(4506877), caption: "세척 상태", isSample: true },
      { url: gpPx(34857767), caption: "수확 현장", isSample: true },
      { url: gpPx(32536921), caption: "청정 D농원 전경", isSample: true },
    ] },
  { id: 5, name: "감귤 3kg", emoji: "🍊", farm: "청정 D농원", region: "충청남도 논산시", category: "과일", price: 18000, measured: false, water: 90, soil: 1.1, carbon: 130, stock: 50,
    ...
    gallery: [
      { url: gpPx(20376486), caption: "대표 이미지", isSample: true },
      { url: gpPx(14704997), caption: "과육 클로즈업", isSample: true },
      { url: gpPx(36791062), caption: "패키지 구성", isSample: true },
      { url: gpPx(37260273), caption: "수확 직후", isSample: true },
      { url: gpPx(18023250), caption: "청정 D농원 인근 지역 전경", isSample: true },
    ] },
];
